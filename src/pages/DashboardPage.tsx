...
import { buildHierarchicalOptions, sortDonViByThuTu, groupParentUnits, getDefaultUnitId } from '../utils/hierarchy';
  ...
  return (
    <div className="flex w-full max-w-full h-full bg-[#f8fafc] overflow-hidden relative">
      ...
      <div className="flex-1 min-w-0 max-w-full overflow-y-auto p-4 sm:p-6 lg:p-8 relative transition-all duration-300">
        ...
        {/* Header Dashboard */}
        <div className={`flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 transition-all duration-300 ${isListCollapsed ? 'md:pl-10 lg:pl-0' : ''}`}>
